...
def normalize_hermes_tweet(item: object) -> dict:
    ...
    normalized = {
        ...
        "quote_count": _first_int(
            item.get("quote_count"),
            item.get("quoteCount"),
            metrics.get("quote_count"),
            metrics.get("quoteCount"),
        ) or 0,
        "bookmark_count": _first_int(
            item.get("bookmark_count"),
            item.get("bookmarkCount"),
            metrics.get("bookmark_count"),
            metrics.get("bookmarkCount"),
        ) or 0,
        "view_count": _first_int(
            ...
            metrics.get("viewCount"),
            metrics.get("impression_count"),
            metrics.get("impressionCount"),
        ),
